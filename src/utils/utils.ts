...
export const    TRANSACTION_MULTIMEDIA_PROMPT = `Analiza y clasifica la siguiente transacción utilizando la descripción proporcionada por el usuario y los datos extraídos automáticamente desde la imagen. Sigue estas reglas:
